...
class TCP(IPv4, dict):
    def __init__(self, raw_data):
        ...
        dict.__init__(self, raw_data=raw_data, src=self.src, dest=self.dest, offset=self.offset, seq=self.seq, ack=self.ack, urg=self.urg, psh=self.psh, rst=self.rst, syn=self.syn, fin=self.fin, name='TCP')
